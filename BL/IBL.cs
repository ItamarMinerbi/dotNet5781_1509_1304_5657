...
namespace BlApi
{
    public interface IBL
    {
        ...
        void UpdateLine(int Id, int lineNumber, BO.Line.Areas area);
        ...
        void StopSimulator();
        void SetStationPanel(int station, Action<BO.LineTiming> updateBus, int mode = 1);
        #endregion
    }
}